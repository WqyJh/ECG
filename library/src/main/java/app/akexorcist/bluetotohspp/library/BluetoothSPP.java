...
public class BluetoothSPP {
    ...
    public interface OnByteReceivedListener {
        /**
         * 数据范围0~255
         *
         * @param b
         */
        void onByteReceived(int b);
    }
    ...
    private final Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case BluetoothState.MESSAGE_READ_BYTE:
                    if (mByteReceivedListener != null) {
                        mByteReceivedListener.onByteReceived(msg.arg1);
                    }
                    break;
    ...
    public void setOnByteReceivedListener(OnByteReceivedListener listener) {
        mByteReceivedListener = listener;
    }
