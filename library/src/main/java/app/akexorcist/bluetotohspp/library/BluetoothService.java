...
public class BluetoothService {
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        mConnectedThread = new ConnectedThread2(socket, socketType);
    ...
    private class ConnectedThread2 extends ConnectedThread {

        public ConnectedThread2(BluetoothSocket socket, String socketType) {
            super(socket, socketType);
        }
        ...
        public void run() {
            while (true) {
                try {
                    int data = mmInStream.read();
                    mHandler.obtainMessage(BluetoothState.MESSAGE_READ_BYTE,
                            data, -1).sendToTarget();
                } catch (IOException e) {
                    connectionLost();
                    break;
